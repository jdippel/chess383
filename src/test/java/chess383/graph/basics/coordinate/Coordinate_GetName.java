...
public class Coordinate_GetName {
    ...
    /**
     * the public method String getName( ) is tested.
     */

    private final String input;
    private final String expectedOutput;

    public Coordinate_GetName( final String input, final String expectedOutput ) {
    ...
    public void namingACoordinateReturnsTheNameDefined( ) {
        ...
        assertEquals( message, expectedOutput, coordinate.getName( ) );
    }
